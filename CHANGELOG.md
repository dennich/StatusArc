...
- Battery percentages use 7-point rounded regular type, input-source labels use rounded bold type, and the compact VPN marker uses lowered 6-point rounded regular type with wider letter spacing.
