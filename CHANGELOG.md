...
- Battery percentages use 8-point rounded bold type, input-source labels use rounded bold type, and the compact VPN marker uses lowered 6-point rounded bold type with wider letter spacing.
